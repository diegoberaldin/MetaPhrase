...
| [toModel](to-model.html) | [jvm]<br>abstract fun ResultRow.[toModel](to-model.html)(): [SegmentModel](../../com.github.diegoberaldin.metaphrase.domain.project.data/-segment-model/index.html) |
